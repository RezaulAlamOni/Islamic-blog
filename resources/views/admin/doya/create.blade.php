...
{!! Form::open(array('route' => config('quickadmin.route').'.doya.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('articles', old('articles'), array('class'=>'form-control','rows'=>20)) !!}
