...
{!! Form::open(array('route' => config('quickadmin.route').'.akida.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    {!! Form::label('pic', 'ফাইল*', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::file('photo', old('pic'), array('class'=>'form-control')) !!}
