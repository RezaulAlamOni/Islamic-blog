...
return [
  ...
  'templates-customView_index-list' => 'তালিকা ',
  'templates-customView_index-welcome_custom_view' => 'Welcome to your custom view',

  // templates-view_create
  'templates-view_create-add_new' => 'নতুন যোগ করুন ',
  'templates-view_create-create' => 'সংরক্ষণ করুন ',

  // templates-view_create
  'templates-view_edit-edit' => 'সম্পাদন করুন ',
  'templates-view_edit-update' => 'আপডেট করুন',
  'templates-view_edit-cancel' => 'Cancel',

  // templates-view_index
  'templates-view_index-add_new' => 'নতুন যোগ করুন ',
  'templates-view_index-list' => 'তালিকা ',
  'templates-view_index-edit' => 'সম্পাদন করুন ',
  'templates-view_index-delete' => 'ডিলিট করুন ',
  'templates-view_index-delete_checked' => 'Delete checked',
  'templates-view_index-confirm_deletion2' => 'Confirm deletion?',  
  'templates-view_index-no_entries_found' => 'কোনো তথ্য পাওয়া যাই নি ',
